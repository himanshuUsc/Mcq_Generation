...
annotator=Annotator()
docs2=pickle.load(open('questions_list.pkl','rb'))
# print docs2
...
def get_key(sentence):
	...
	for j in range(len(y)):
		...
		elif ((temp[1]=='S-LOC' or temp[1]=='E_LOC' or temp[1]=='S-MISC') and c==1):
			loc1=str(temp[0])
			# print j,"answer is ",loc1
...
if __name__ == '__main__':
 ...
 #  	s=A.to_array()
	...
	# model.save('train2.doc2vec')
	model=gensim.models.Doc2Vec.load('train2.doc2vec')
	# print(model)
	# x=9
	# print(words[x])
	# print(repr(model))
